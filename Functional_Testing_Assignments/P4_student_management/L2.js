 ...
 function readFormData() {
     ...
     formData["tmarks"] = document.getElementById("tmarks").value;
 ...
 function onEdit(td) {
     ...
     document.getElementById("tmarks").value = selectedRow.cells[4].innerHTML;
 ...
 function updateRecord(formData) {
     ...
     selectedRow.cells[4].innerHTML = formData.tmarks;
